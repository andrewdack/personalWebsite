...
export function CustomExpressIcon({
    size,
    color = "#000000",
    strokeWidth = 2,
    ...
    return (
        ...
        >
            <defs>
                {/* In light mode the mark is punched clean through the badge
                    (path filled black = masked out); in dark mode the mask
                    lets the whole badge through and the solid path below
                    draws the mark instead. */}
                <mask id="express-mark-mask" maskUnits="userSpaceOnUse">
                    <rect width="256" height="256" fill="white" rx="60" />
                    <path d={EXPRESS_MARK_PATH} className="fill-black dark:fill-white" />
                </mask>
            </defs>
            <g fill="none">
                <rect
